...
while j < len(new_list):
    ...
    with open('/Downloads/dingxy/20200208/'+s+'.csv', encoding='utf-8-sig', mode='w',newline='') as f:
    ...
    def save_data(data):
        with open('/Downloads/dingxy/20200208/'+s+'.csv', encoding='UTF-8', mode='a+',newline='') as f:
            f_csv = csv.writer(f)
            f_csv.writerow(data)
        f.close()
